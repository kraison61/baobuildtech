...
@php
    ...
    $specsBySlug = [
        ...
        'piles-foundation' => [
            ['label' => 'ชนิดเข็ม', 'value' => 'เจาะ · ไมโครไพล์ · เหล็ก · ไอ · หกเหลี่ยม'],
            ['label' => 'โมเดลงาน', 'value' => 'พาร์ตเนอร์ติดตั้ง · วิศวกร BOA ควบคุม'],
            ['label' => 'ราคาตอก (ไอ)', 'value' => 'เริ่ม 26,400 บาท (ยังไม่รวม VAT)'],
            ['label' => 'พื้นที่หลัก', 'value' => 'ปทุมธานี–นนทบุรี'],
            ['label' => 'เอกสารส่งมอบ', 'value' => 'BOQ · Pile Record · As-built'],
        ],
        'survey' => [
