@php
    $faqs = \App\Support\HomeContent::faqs();
@endphp

<section id="faq" class="scroll-mt-24 bg-white py-16 lg:py-24">
    <x-front.container>
        <div class="mx-auto max-w-[680px]">
            <h2 class="text-[clamp(1.625rem,4vw,2rem)] font-semibold leading-[1.4] text-brand">คำถามที่พบบ่อย</h2>

            <div class="mt-10 grid gap-4">
                @foreach ($faqs as $faq)
                    <details name="home-faq" class="group rounded-lg border border-line bg-paper px-6 py-1" @if ($faq['open'] ?? false) open @endif>
