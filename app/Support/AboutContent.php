...
class AboutContent
{
    ...
    {
        return 'เรื่องราว BOA (Build Operate Assure) ทีมวิศวกรคุมหน้างานเอง งานโยธา อลูมิเนียม และระบบจบในสัญญาเดียว กรุงเทพฯ และปริมณฑล';
    }
    ...
    {
        return [
            'BOA ย่อมาจาก Build Operate Assure สะท้อนวิธีทำงานสามขั้น คือสร้างให้ได้มาตรฐาน ส่งมอบระบบที่ใช้งานได้จริง และตรวจสอบให้มั่นใจ',
