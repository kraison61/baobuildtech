    ...
    private function seedServices(array $categories): array
    {
        ...
        $rows = [
            [
                ...
                'meta_title' => 'งานสำรวจ | BOA-Buildtech',
            ...
            [
                ...
                'description' => 'รับเหมางานเสาเข็มเจาะ ไมโครไพล์ เสาเข็มเหล็ก เสาเข็มไอ และเสาเข็มหกเหลี่ยม สำหรับโรงงาน โครงการ และบ้านพักอาศัย ติดตั้งโดยพาร์ตเนอร์ ควบคุมโดยวิศวกรโยธาของ BOA-Buildtech',
                'excerpt' => 'เสาเข็มเจาะ · ไมโครไพล์ · เสาเข็มเหล็ก · เสาเข็มไอ · หกเหลี่ยม',
                'cover_image' => null,
                'service_type' => 'FoundationContractor',
                'meta_title' => 'เสาเข็ม รับเหมาครบทุกระบบ สำหรับโรงงานและโครงการ | BOA-Buildtech',
            ...
            [
                ...
                'meta_title' => 'งานโครงสร้าง | BOA-Buildtech',
            ...
            [
                ...
                'meta_title' => 'บริหารงานก่อสร้าง | BOA-Buildtech',
            ...
            [
                ...
                'meta_title' => 'งานสุขาภิบาล | BOA-Buildtech',
            ...
            [
                ...
                'meta_title' => 'ระบบไฟฟ้า เดินสายไฟ โซล่าเซลล์ | BOA-Buildtech',
            ...
            [
                ...
                'meta_title' => 'สายสัญญาณ ไฟเบอร์ LAN | BOA-Buildtech',
            ...
            [
                ...
                'meta_title' => 'กล้องวงจรปิด | BOA-Buildtech',
    ...
    private function seedServiceItems(array $services): array
    {
        ...
        $rows = [
            ...
            [
                ...
                'meta_title' => 'กำแพงกันดิน คสล. | BOA-Buildtech',
    ...
    private function seedServicePrices(array $services, array $items): void
    {
        ...
        $prices = [
            ...
            [
                ...
                'price_max' => 347,
                'price_unit' => 'บาท/ม.',
                'note' => 'ตอก 2 ท่อนต่อเชื่อม · ยังไม่รวม VAT · อัปเดต ก.ย. 2569 · ขนาด I 0.18–0.30 ม.',
                'is_visible' => true,
                'sort_order' => 1,
            ],
            [
            ...
            [
                ...
                'price_max' => 110000,
                'price_unit' => 'บาท',
                'note' => 'ตอก 2 ท่อนต่อเชื่อม · ยังไม่รวม VAT · อัปเดต ก.ย. 2569 · ขั้นต่ำจำนวนต้นตามขนาดเสา',
                'is_visible' => true,
                'sort_order' => 3,
            ],
            [
            ...
            [
                ...
                'price_max' => 473,
                'price_unit' => 'บาท/ม.',
                'note' => 'ตอก 2 ท่อนต่อเชื่อม · ยังไม่รวม VAT · อัปเดต ก.ย. 2569 · ขนาด 0.18–0.30 ม.',
                'is_visible' => true,
                'sort_order' => 5,
            ],
            [
    ...
    private function seedLocations(): array
    {
        $rows = [
            [
                ...
                'meta_description' => 'BOA-Buildtech รับงานกำแพงกันดินและฐานรากในนนทบุรี',
                'is_published' => true,
            ],
            [
                'name' => 'กรุงเทพฯ',
